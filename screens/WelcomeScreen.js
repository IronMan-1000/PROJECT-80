    ...
    return (
      ...
      <ImageBackground source={image} style={styles.image}>
       ...
       <View style={styles.profileContainer}>
        ...
        This is the Barter App. A place where you can get connected to each and share books with each other. Need a book this is the right place to get it. It is totally free. You can try it. Interested then lets help you make an account.👇
        </Text>
        </View>
